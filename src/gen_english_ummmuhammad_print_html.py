#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate print-ready A5 HTML for English Umm Muhammad translation.

Run from repository root:
    python3 src/gen_english_ummmuhammad_print_html.py
"""
...
IN_FILE = "output/quran_english_ummmuhammad.txt"
OUT_FILE = "output/english_ummmuhammad_print.html"
...
def main():
    ...
    for ln in lines:
        ...
        if m_surah:
            ...
            body.append("<section class='surah'><h2>Surah %03d: %s</h2>" % (sn, esc(m_surah.group(2))))
            continue
...
<head>
  ...
  <title>English Umm Muhammad (Print A5)</title>
  <style>
    @font-face{
    ...
    *{box-sizing:border-box}
    body{
      ...
      color:#111;
      background:#fff;
      font-family:'SourceSerif4','Source Serif 4','Times New Roman',serif;
      font-size:11.2pt;
      line-height:1.58;
      text-wrap:pretty;
    }
...
<body>
  <h1>The Quran — English Translation (Umm Muhammad)</h1>
  __BODY__
