#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate print-ready A5 HTML for Hindi Farooq translation.

Run from repository root:
    python3 src/gen_hindi_farooq_print_html.py
"""
...
IN_FILE = "output/quran_hindi_farooq.txt"
OUT_FILE = "output/hindi_farooq_print.html"
...
<head>
  ...
  <title>Hindi Farooq (Print A5)</title>
  <style>
    @font-face{
...
<body>
  <h1>कुरआन हिंदी अनुवाद (फ़ारूक़)</h1>
  __BODY__
