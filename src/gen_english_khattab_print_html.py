#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate print-ready A5 HTML for English Khattab translation.

Run from repository root:
    python3 src/gen_english_khattab_print_html.py
"""
...
IN_FILE = "output/quran_english_khattab.txt"
OUT_FILE = "output/english_khattab_print.html"
...
<head>
  ...
  <title>English Khattab (Print A5)</title>
  <style>
    @font-face{
    ...
    *{box-sizing:border-box}
    body{
      ...
      color:#111;
      background:#fff;
      font-family:'EBGaramond','EB Garamond','Times New Roman',serif;
      font-size:11.2pt;
      line-height:1.58;
      text-wrap:pretty;
    }
...
<body>
  <h1>The Quran — English Translation (Khattab)</h1>
  __BODY__
