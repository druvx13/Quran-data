#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate print-ready A5 HTML for Quran Unicode transliteration.

Run from repository root:
    python3 src/gen_translit_unicode_print_html.py
"""
...
IN_FILE = "output/quran_translit_unicode.txt"
OUT_FILE = "output/translit_unicode_print.html"
...
<head>
  ...
  <title>Quran Unicode Transliteration (Print A5)</title>
  <style>
    @font-face{
    ...
    *{box-sizing:border-box}
    body{
      ...
      color:#111;
      background:#fff;
      font-family:'NotoSerif','Noto Serif','Times New Roman',serif;
      font-size:11.2pt;
      line-height:1.58;
      text-wrap:pretty;
    }
...
<body>
  <h1>The Quran — Unicode Transliteration</h1>
  __BODY__
