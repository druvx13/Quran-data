#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate print-ready A5 HTML for Roman Urdu (Maududi) translation.

Run from repository root:
    python3 src/gen_roman_urdu_maududi_print_html.py
"""
...
IN_FILE = "output/quran_roman_urdu_maududi.txt"
OUT_FILE = "output/roman_urdu_maududi_print.html"
...
<head>
  ...
  <title>Quran Roman Urdu (Maududi) Print A5</title>
  <style>
    @font-face{
    ...
    *{box-sizing:border-box}
    body{
      ...
      color:#111;
      background:#fff;
      font-family:'CrimsonText','Crimson Text','Times New Roman',serif;
      font-size:11.2pt;
      line-height:1.58;
      text-wrap:pretty;
    }
...
<body>
  <h1>The Quran — Roman Urdu Translation (Maududi)</h1>
  __BODY__
