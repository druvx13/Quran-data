...
// Path to the repository data directories (relative to this file's location)
define('REPO_ROOT', dirname(__DIR__, 2) . '/');
define('OUTPUT_DIR', REPO_ROOT . 'output/');
define('TRANS_DIR',  REPO_ROOT . 'trans/');

// Surah verse counts (114 entries, 0-indexed internally, displayed 1-indexed)
...
// Surah names (1-indexed via SURA_NAME[1] … SURA_NAME[114])
const SURA_NAME = [
...
/** Return verse count for surah $n (1–114), or 0 if invalid. */
function surah_size(int $n): int {
    return (isset(SURA_SIZE[$n - 1])) ? SURA_SIZE[$n - 1] : 0;
}

/** Return surah name for surah $n (1–114), or '' if invalid. */
