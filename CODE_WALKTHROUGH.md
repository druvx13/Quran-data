...
Lines 1800-1970: index.html, search.html, search-data.js, special pages
```
...
The search index is a JavaScript file that assigns a global object:
```javascript
const searchData = {
  "1": { "name": "Al-Fatihah", "ayahs": [
    { "ref": "1:1", "ar": "...", "translit": "...", "ya": "...", "hi": "..." },
    ...
  ]},
  ...
};
```
This enables the search page to do in-browser full-text search without any server round-trips.
